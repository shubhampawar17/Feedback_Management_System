...
<body>
    <center>
        ...
        + "[A-Za-z]$" required size="30" min=2 onchange="this.value = this.value.trim()">
                ...
                <label for="feedback" style="color: black;"><b>Feedback</b></label><br>
...
<label for="star5" style="color: black;">Excellent</label>

  		        <span class="checkmark"></span>
	        	</label>
			<label class="container">
  			<input type="radio" id="star4" name="rate" value="4">
<label for="star4" style="color: black;">Very Good</label>

  			<span class="checkmark"></span>
			</label>
			<label class="container">
  			<input type="radio" id="star3" name="rate" value="3">
<label for="star3" style="color: black;">Good</label>

  			<span class="checkmark"></span>
			</label>
			<label class="container">
  			<input type="radio" id="star2" name="rate" value="2">
<label for="star2" style="color: black;">Satisfactory</label>

  			<span class="checkmark"></span>
			</label>
			<label class="container">
  			<input type="radio" id="star1" name="rate" value="1">
<label for="star1" style="color: black;">Poor</label>

  			<span class="checkmark"></span>
			</label>
                <button type="submit" class="sign" name="btn" style="color: black;">Submit</button>
                <a href="index.jsp"><button type="button" class="sign" style="color: black;">Back</button></a>
